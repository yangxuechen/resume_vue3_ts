...
const colors = reactive<ColorItem[]>([
  { color: "#273036", background: "background-color:#273036" },
...
const list = ref<any[]>([
  { componentName: "AvatarTop4" },
  { componentName: "JobIntension3" },
  { componentName: "EducationB" },
  { componentName: "WorkExperience3" },
  { componentName: "OpenSourcePro2" },
]);
