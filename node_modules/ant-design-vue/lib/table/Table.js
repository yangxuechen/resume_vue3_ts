...
var createComponents = function createComponents() {
  ...
  return (0, _extends4.default)((0, _extends4.default)({}, components), {
    body: (0, _extends4.default)((0, _extends4.default)({}, components.body), {
...
var _default2 = (0, _vue.defineComponent)({
  ...
  data: function data() {
    ...
    return (0, _extends4.default)((0, _extends4.default)({}, getDefaultSortOrder(props.columns || [])), {
      // 减少状态
  ...
  watch: {
    pagination: {
      handler: function handler(val) {
        this.setState(function (previousState) {
          var newPagination = (0, _extends4.default)((0, _extends4.default)((0, _extends4.default)({}, defaultPagination), previousState.sPagination), val);
    ...
    columns: function columns(val) {
      ...
      if (filteredValueColumns.length > 0) {
        ...
        var newFilters = (0, _extends4.default)({}, this.sFilters);
  ...
  methods: {
    ...
    getDefaultPagination: function getDefaultPagination(props) {
      var pagination = (0, _typeof2.default)(props.pagination) === 'object' ? props.pagination : {};
      var current;
      ...
      return this.hasPagination(props) ? (0, _extends4.default)((0, _extends4.default)((0, _extends4.default)({}, defaultPagination), pagination), {
        current: current || 1,
    ...
    getDefaultFilters: function getDefaultFilters(columns) {
      ...
      return (0, _extends4.default)((0, _extends4.default)({}, defaultFilters), definedFilters);
    },
    ...
    getLocalData: function getLocalData(state) {
      ...
      if (sorterFn) {
        ...
        data = this.recursiveSort((0, _toConsumableArray2.default)(data), sorterFn);
      } // 筛选
    ...
    onRow: function onRow(prefixCls, record, index) {
      ...
      return (0, _extends4.default)((0, _extends4.default)({}, custom), {
        prefixCls: prefixCls,
        store: this.store,
    ...
    handleFilter: function handleFilter(column, nextFilters) {
      ...
      var pagination = (0, _extends4.default)({}, this.sPagination);
      var filters = (0, _extends4.default)((0, _extends4.default)({}, this.sFilters), (0, _defineProperty2.default)({}, getColumnKey(column), nextFilters)); // Remove filters not in current columns
      ...
      if ((0, _typeof2.default)(props.pagination) === 'object' && 'current' in props.pagination) {
        newState.sPagination = (0, _extends4.default)((0, _extends4.default)({}, pagination), {
      ...
      this.setState(newState, function () {
        ...
        _this5.$emit.apply(_this5, ['change'].concat((0, _toConsumableArray2.default)(_this5.prepareParamsArguments((0, _extends4.default)((0, _extends4.default)({}, _this5.$data), {
    ...
    handlePageChange: function handlePageChange(current) {
      ...
      this.store.selectionDirty = false;
      this.$emit.apply(this, ['change'].concat((0, _toConsumableArray2.default)(this.prepareParamsArguments((0, _extends4.default)((0, _extends4.default)({}, this.$data), {
        sSelectionDirty: false,
        sPagination: pagination
      })))));
    },
    handleShowSizeChange: function handleShowSizeChange(current, pageSize) {
      ...
      var nextPagination = (0, _extends4.default)((0, _extends4.default)({}, pagination), {
        pageSize: pageSize,
        current: current
      });
      this.setState({
    ...
    toggleSortOrder: function toggleSortOrder(column) {
      ...
      this.$emit.apply(this, ['change'].concat((0, _toConsumableArray2.default)(this.prepareParamsArguments((0, _extends4.default)((0, _extends4.default)({}, this.$data), newState), column))));
    },
    ...
    prepareParamsArguments: function prepareParamsArguments(state, column) {
      var pagination = (0, _extends4.default)({}, state.sPagination); // remove useless handle function in Table.onChange
    ...
    recursiveSort: function recursiveSort(data, sorterFn) {
      ...
      return data.sort(sorterFn).map(function (item) {
        return item[childrenColumnName] ? (0, _extends4.default)((0, _extends4.default)({}, item), (0, _defineProperty2.default)({}, childrenColumnName, _this8.recursiveSort((0, _toConsumableArray2.default)(item[childrenColumnName]), sorterFn))) : item;
      });
    },
          ...
          return (0, _vue.createVNode)(_LocaleReceiver.default, {
            ...
            "children": function children(locale) {
              ...
              return (0, _vue.createVNode)(_transButton.default, {
                "class": (0, _classNames5.default)("".concat(prefixCls, "-row-expand-icon"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-row-collapsed"), !expanded), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-row-expanded"), expanded), _classNames)),
    ...
    renderPagination: function renderPagination(prefixCls, paginationPosition) {
      ...
      var paginationProps = (0, _extends4.default)((0, _extends4.default)({
    ...
    renderSelectionBox: function renderSelectionBox(type) {
      ...
      return function (_ref3) {
        ...
        var selectionBoxProps = (0, _extends4.default)({
          type: type,
          store: _this9.store,
          rowIndex: rowKey,
    ...
    renderRowSelection: function renderRowSelection(_ref4) {
      ...
      if (rowSelection) {
        ...
        var selectionColumnClass = (0, _classNames5.default)("".concat(prefixCls, "-selection-column"), (0, _defineProperty2.default)({}, "".concat(prefixCls, "-selection-column-custom"), rowSelection.selections));
    ...
    renderColumnsDropdown: function renderColumnsDropdown(_ref5) {
      ...
      return (0, _util.treeMap)(columns, function (column, i) {
        ...
        if (column.sorter) {
          ...
          customHeaderCell = function customHeaderCell(col) {
            ...
            if (column.customHeaderCell) {
              colProps = (0, _extends4.default)({}, column.customHeaderCell(col));
            } // Add sorter logic
        ...
        return (0, _extends4.default)((0, _extends4.default)({}, column), {
          className: (0, _classNames5.default)(column.className, (_classNames3 = {}, (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-column-has-actions"), sortButton || filterDropdown), (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-column-has-filters"), filterDropdown), (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-column-has-sorters"), sortButton), (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-column-sort"), isSortColumn && sortOrder), _classNames3)),
    ...
    renderTable: function renderTable(_ref6) {
      ...
      var _a = (0, _extends4.default)((0, _extends4.default)({}, (0, _propsUtil.getOptionProps)(this)), this.$attrs),
      ...
      var mergedLocale = (0, _extends4.default)((0, _extends4.default)({}, contextLocale), locale);

      if (!locale || !locale.emptyText) {
        mergedLocale.emptyText = renderEmpty('Table');
      }

      var classString = (0, _classNames5.default)((_classNames4 = {}, (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-").concat(this.size), true), (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-bordered"), this.bordered), (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-empty"), !data.length), (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-without-column-header"), !showHeader), _classNames4));
      ...
      var columns = this.renderColumnsDropdown({
        ...
        var newColumn = (0, _extends4.default)({}, column);
      ...
      var vcTableProps = (0, _extends4.default)((0, _extends4.default)({
        key: 'table',
  ...
  render: function render() {
    ...
    var spinProps = (0, _extends4.default)((0, _extends4.default)({}, loading), {
